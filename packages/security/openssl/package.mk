...
pre_configure_host() {
  mkdir -p /root/Lakka-LibreELEC/$PKG_BUILD/.$HOST_NAME
  cp -a /root/Lakka-LibreELEC/$PKG_BUILD/* /root/Lakka-LibreELEC/$PKG_BUILD/.$HOST_NAME/
}

configure_host() {
  cd /root/Lakka-LibreELEC/$PKG_BUILD/.$HOST_NAME
...
pre_configure_target() {
  mkdir -p /root/Lakka-LibreELEC/$PKG_BUILD/.$TARGET_NAME
  cp -a /root/Lakka-LibreELEC/$PKG_BUILD/* /root/Lakka-LibreELEC/$PKG_BUILD/.$TARGET_NAME/
...
configure_target() {
  cd /root/Lakka-LibreELEC/$PKG_BUILD/.$TARGET_NAME
